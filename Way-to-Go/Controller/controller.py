...
from Model.DirectoryModel.dir_model_errors import ConstructionError
...
class Controller:
    ...
    def update_routes(self):
        ...
        except ConstructionError as e:  # SegmentFactory has failed
            self.view.display_error("Unable to construct the Directory")
        except OSError as e2:  # GeoUtils has failed
            self.view.display_error("GeoUtils is busted")
